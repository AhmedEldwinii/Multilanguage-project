...
@section('index')
    ...
    <div class="card-header">
        <h3 class="btn btn-block btn-info ">Edit Post</h3>
    </div>
        ...
        <div class="card-body ">
            ...
            <div class=" col mb-3">
                    ...
                    <input class="form-control dropify" type="file" id="formFile" name="image"
                        data-default-file="{{ asset($post->image) }}">
                    </div>
            </div>
                ...
                <div class="tab-pane fade @if($loop->index == 0) show active in @endif" id="{{ $key }}" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            value="{{ optional($post->translate($key))->title }}" placeholder="Title" name="{{ $key }}[title]">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            value="{{ optional($post->translate($key))->smallDesc }}"id ="editor" name="{{ $key }}[smallDesc]"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="width: 100%;">
                        <div class="input-group mb-3">
                            ...
                            <textarea type="text" class="form-control"
                            value="{{ optional($post->translate($key))->content}}" id ="editor" name="{{ $key }}[content]"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="width: 100%;">
                        <div class="input-group mb-3">
                            ...
                            <textarea type="text" class="form-control"
                            value="{{ optional($post->translate($key))->tags}}"   name="{{ $key }}[tags]"></textarea>
                        </div>
                    </div>
                </div>
            @endforeach
